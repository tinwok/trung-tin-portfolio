...
function SendEmailInputForm({ icon, placeholder, className = '' }) {
    return (
        <form
            className={` flex items-center gap-4 ${className}  border border-[var(--color-description)] px-1 py-1 rounded-full w-2/3 lg:max-w-[668px] mx-auto`}
        >
            ...
            <input
                ...
                className="w-[485px] h-full outline-none flex-1 text-xs lg:text-xl min-w-0"
            />
