...
function HireMe() {
    return (
        <section className="px-6 mt-[50px]">
            <div className="max-w-[1200px] mx-auto py-6 lh:h-[604px] bg-[#E2E2E2] rounded-4xl flex justify-evenly items-center">
                <div className="left-side mx-6 lg:w-[50%]">
                    ...
                    <div>
                        ...
                        <p className="lg:text-xl ml-5 text-[var(--color-description)]">{HireMeData.description}</p>
                    </div>
                    <div className="flex gap-20 mb-[38px]  mt-[38px]">
                        {HireMeData.state.map((item) => {
                            return (
                                <div>
                                    <span className="lg:text-2xl font-semibold">{item.stateNumber}</span>
                                    <p className="text-[var(--color-description)] lg:text-xl font-medium">
                                        {item.stateDes}
                                    </p>
                                </div>
                            );
